...
th main.lua -data gen/Flicker8k_Dataset -dataset flickr8k -finetune 1 -finetuneAfter 50 -cnnType vggnet -skipFlag true -cnnCaffe pretrained/VGG_ILSVRC_16_layers.caffemodel -cnnProto pretrained/VGG_ILSVRC_16_layers_deploy.prototxt -cnnCaffelayernum 38
