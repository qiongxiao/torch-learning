--[[
--
--  code from "https://raw.githubusercontent.com/facebook/fb.resnet.torch/master/datasets/imagenet-gen.lua"
--
...
function M.exec(opt, cacheFile)
	...
	print("<data init>  | finding all validation images")
	local valImagePath, valImageClass = findImages(valDir, classToIdx)

	print("<data init>  | finding all training images")
	...
	print("<data init>  | saving list of images to " .. cacheFile)
